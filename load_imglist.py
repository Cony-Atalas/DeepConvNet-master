...
def default_loader(path, otype = 'img'):
    if otype == 'img':
        ...
        # TF.normalize(img,[0.4637632, 0.43115112, 0.3904229],[0.26601478, 0.263291, 0.27608517])
        return img
    elif otype == 'gt':
...
class ImageList(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #将后面添加的路径中的\替换成/
        # imgPath = imgPath[0:5]+'/'+imgPath[6:]
        # gtPath  = gtPath[0:4]+'/'+gtPath[5:10]+'/'+gtPath[9:]
